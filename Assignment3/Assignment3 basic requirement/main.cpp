...
//    gluLookAt(g_view_pos.x(), g_view_pos.y(), g_view_pos.z(), g_view_dir.x(), g_view_dir.y(), g_view_dir.z(), 0, 1, 0);//this should be execute at last
    //cout<<g_view_pos.x()<<" "<<g_view_pos.z()<<"\n";
